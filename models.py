...
class CNN_Encoder(nn.Module):
    ...
    def forward(self, images):
        ...
        if 'resnet' in self.NetType:
            out = self.net(images)  # (batch_size, 2048, image_size/32, image_size/32) (batch_size, 1024, image_size/16, image_size/16)
            out = self.adaptive_pool(out)  # [batch_size, 2048/512, 8, 8] -> [batch_size, 2048/512, 14, 14] [batch_size, 1024, 14, 14]
